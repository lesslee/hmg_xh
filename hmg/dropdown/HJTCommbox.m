...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        tv = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, frame.size.width/2 +70  , 0)];
        tv.delegate = self;
        tv.dataSource = self;
        ...
        textField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, frame.size.width /2 + 70, 40)];
...
//        [textField addTarget:self action:@selector(dropdown) forControlEvents:UIControlEventAllTouchEvents];
        ...
        btn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, frame.size.width, 40)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.font = [UIFont systemFontOfSize:18.0f];  //下拉选择框中字体大小
