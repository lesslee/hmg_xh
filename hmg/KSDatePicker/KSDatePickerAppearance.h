...
typedef void (^KSDatePickerResult1)(KSDatePicker1* datePicker,NSDate* currentDate,KSDatePickerButtonType buttonType);
...
@property (nonatomic, copy) KSDatePickerResult1  resultCallBack1;
