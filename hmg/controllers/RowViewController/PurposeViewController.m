...
@interface PurposeCell : UITableViewCell
...
- (void)viewDidLoad {
    ...
    array =[NSArray arrayWithObjects:
            [[Purpose alloc] initWithID:@"C5501" andNAME:@"开发"],
            [[Purpose alloc] initWithID:@"C5502" andNAME:@"进店"],
            [[Purpose alloc] initWithID:@"C5503" andNAME:@"活动"],
            [[Purpose alloc] initWithID:@"C5504" andNAME:@"培训"],
            [[Purpose alloc] initWithID:@"C5505" andNAME:@"陈列改善"],
            [[Purpose alloc] initWithID:@"C5506" andNAME:@"日常"],
            [[Purpose alloc] initWithID:@"C5507" andNAME:@"会议"],
            nil];
    ...
    [self.tableView registerClass:[PurposeCell class] forCellReuseIdentifier:kCellIdentifier];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Purpose *model=(Purpose *)[array objectAtIndex:indexPath.row];
