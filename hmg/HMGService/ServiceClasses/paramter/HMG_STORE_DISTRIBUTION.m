...
@implementation HMG_STORE_DISTRIBUTION
@synthesize IN_AREA_ID=_IN_AREA_ID;
@synthesize IN_DEPT_CD=_IN_DEPT_CD;
@synthesize IN_S_YEAR=_IN_S_YEAR;
...
-(id) initWithCoder:(NSCoder *)aDecoder
{
    if (self=[super init]) {
        ...
        _IN_S_YEAR=[aDecoder decodeObjectForKey:@"IN_S_YEAR"];
...
-(void) encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_IN_S_YEAR forKey:@"IN_S_YEAR"];
