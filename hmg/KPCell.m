...
#pragma 白色方框容器
        ...
        UILabel *kuo = [[UILabel alloc]init];
        kuo.text = @"(";
        kuo.font=[UIFont systemFontOfSize:18];
        kuo.textColor = [self colorWithHexString:@"#7C7C7C" alpha:1];
        [rootView addSubview:kuo];
        
        [kuo mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.Provincial.mas_right).with.offset(2);
            make.top.mas_equalTo(rootView.mas_top).with.offset(10);
            make.centerY.equalTo(self.Provincial.mas_centerY);
        }];
        
        UILabel *mb = [[UILabel alloc]init];
        mb = [[UILabel alloc]init];
        mb.text =@"目标:";
        mb.font=[UIFont systemFontOfSize:18];
        mb.textColor = [self colorWithHexString:@"#7C7C7C" alpha:1];
        [rootView addSubview:mb];
        
        [mb mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(kuo.mas_right).with.offset(1);
            make.top.mas_equalTo(rootView.mas_top).with.offset(10);
            make.centerY.equalTo(self.Provincial.mas_centerY);

        }];

        self.mubiao = [[UILabel alloc]init];
        self.mubiao.font=[UIFont systemFontOfSize:18];
        self.mubiao.textColor = [self colorWithHexString:@"#fd877c" alpha:1];
        [rootView addSubview:self.mubiao];
        
        [self.mubiao mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(mb.mas_right).with.offset(1);
            make.top.mas_equalTo(rootView.mas_top).with.offset(10);
            make.centerY.equalTo(self.Provincial.mas_centerY);

        }];

        UILabel *kuo1 = [[UILabel alloc]init];
        kuo1.text = @")";
        kuo1.font=[UIFont systemFontOfSize:18];
        kuo1.textColor = [self colorWithHexString:@"#7C7C7C" alpha:1];
        [rootView addSubview:kuo1];
        
        [kuo1 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.mubiao.mas_right).with.offset(1);
            make.top.mas_equalTo(rootView.mas_top).with.offset(10);
            make.centerY.equalTo(self.Provincial.mas_centerY);
        ...
        [self.date mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(rootView.mas_top).with.offset(10);
                //make.left.mas_equalTo(kuo1.mas_right).with.offset(10);
            make.centerY.equalTo(self.Provincial.mas_centerY);
        ...
        [self.dentilNU mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.centerY.equalTo(self.uzaNU.mas_centerY);
                //make.right.mas_equalTo(rootView.mas_right).with.offset(-5);
            make.width.mas_equalTo(rootView.mas_width).multipliedBy(0.2);
        }];
        ...
        [line2 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(self.phyllNU.mas_bottom).with.offset(10);
            make.left.mas_equalTo(rootView.mas_left).with.offset(5);
            make.right.mas_equalTo(rootView.mas_right).with.offset(-5);
            make.height.mas_equalTo(@0.5);
        }];
        ...
        self.dachengNU=[[UILabel alloc] init];
        self.dachengNU.font=[UIFont systemFontOfSize:16];
        self.dachengNU.textColor=[self colorWithHexString:@"#fd877c" alpha:1];
        [rootView addSubview:self.dachengNU];
        [self.dachengNU mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            lable3.text = @"同比:";
            lable3.textColor =[self colorWithHexString:@"#7C7C7C" alpha:1];
            lable3.font = [UIFont systemFontOfSize:16];
            [rootView addSubview:lable3];
            
            [lable3 mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(self.dachengNU.mas_right).with.offset(10);
                make.centerY.equalTo(self.dachengNU.mas_centerY);
                make.top.mas_equalTo(line2.mas_bottom).with.offset(10);
                make.bottom.equalTo(rootView.mas_bottom).with.offset(-10);
            }];
            ...
            [self.tbNU mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.mas_equalTo(lable3.mas_right).with.offset(2);
                make.top.mas_equalTo(line2.mas_bottom).with.offset(10);
                make.bottom.equalTo(rootView.mas_bottom).with.offset(-10);
                make.centerY.equalTo(lable3.mas_centerY);
                    //make.width.mas_equalTo(rootView.mas_width).multipliedBy(0.5);
...
{
    static NSString *ID = @"KPCellID";
    KPCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[KPCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
- (void)awakeFromNib {
